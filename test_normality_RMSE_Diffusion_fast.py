...
for test in normalityTests:
    ...
    plt.colorbar()
    plt.title('In-Domain {} test Contour Plot Diffusion'.format(test))
    plt.xlabel('GPR cutoff')
    plt.ylabel('RF cutoff')
    plt.savefig('In-Domain {} test Contour Plot Diffusion data.png'.format(test))
    plt.clf()
    ...
    plt.colorbar()
    plt.title('Out-Domain {} test Contour Plot Diffusion'.format(test))
    plt.xlabel('GPR cutoff')
    plt.ylabel('RF cutoff')
    plt.savefig('Out-Domain {} test Contour Plot Diffusion data.png'.format(test))
    plt.clf()

fd = open('Normality_tests_Diffusion_data_logs.txt', 'w')
