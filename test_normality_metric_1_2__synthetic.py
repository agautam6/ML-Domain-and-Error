...
# Load models
rf_filename = 'models/rf_synth_model_mf_1000.sav'
gpr_filename = 'models/gpr_synth_model_mf_1000.sav'
    ...
    for b_i in bin_sizes:
        ...
        if contour_plot_same_scale:
            if test is 'MetricOne' or test is 'MetricTwo':
                ...
                in_domain_clevels = np.linspace(min(np.min(in_domain_norm_score_cur), np.min(out_domain_norm_score_cur)),
